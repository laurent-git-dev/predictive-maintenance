# incidents — silver dataset report
...
### datetime (<span style="color:green">OK</span>)

- **dtype** datetime64[us] · **count** 1245 · **unique** 1241 · **missing** 0 (0.0%)
- **range** 2025-06-01 05:42 → 2026-06-08 00:29 (span 371 days)

### hour (<span style="color:green">OK</span>)

- **dtype** Int64 · **count** 1245 · **unique** 24 · **missing** 0 (0.0%)
- **range** 0.0 → 23.0 (span 23.0) · **Q1/median/Q3** 6.0 / 12.0 / 17.0
- **mean** 11.562 · **std** 6.816 · **skew** -0.053
...
- **dtype** Int64 · **count** 1245 · **unique** 7 · **missing** 0 (0.0%)
- **range** 0.0 → 6.0 (span 6.0) · **Q1/median/Q3** 1.0 / 3.0 / 5.0
- **mean** 3.129 · **std** 1.961 · **skew** -0.09
...
### month (<span style="color:green">OK</span>)

- **dtype** Int64 · **count** 1245 · **unique** 12 · **missing** 0 (0.0%)
- **range** 1.0 → 12.0 (span 11.0) · **Q1/median/Q3** 4.0 / 6.0 / 9.0
- **mean** 6.478 · **std** 3.406 · **skew** 0.032
...
### is_weekend (<span style="color:green">OK</span>)

- **dtype** Int64 · **count** 1245 · **unique** 2 · **missing** 0 (0.0%)
- **distinct values**: 0 (69.0%), 1 (31.0%)

![is_weekend](3.10_count_is_weekend.png)

### comment_pii_flag (<span style="color:green">OK</span>)

- **dtype** bool · **count** 1245 · **unique** 1 · **missing** 0 (0.0%)
- **distinct values**: True (100.0%)

![comment_pii_flag](3.11_count_comment_pii_flag.png)

### production_stop_flag (<span style="color:green">OK</span>)

- **dtype** Int64 · **count** 1245 · **unique** 2 · **missing** 0 (0.0%)
- **distinct values**: 0 (98.5%), 1 (1.5%)

![production_stop_flag](3.12_count_production_stop_flag.png)

### n_active_signals (<span style="color:green">OK</span>)

- **dtype** int64 · **count** 1245 · **unique** 2 · **missing** 0 (0.0%)
- **range** 1.0 → 2.0 (span 1.0) · **Q1/median/Q3** 1.0 / 1.0 / 1.0
- **mean** 1.012 · **std** 0.109 · **skew** 8.956
...
![n_active_signals](2.1_dist_n_active_signals.png)

### confidence_index (<span style="color:green">OK</span>)

- **dtype** float64 · **count** 1245 · **unique** 2 · **missing** 0 (0.0%)
- **distinct values**: 0.1111 (98.8%), 0.2222 (1.2%)

![confidence_index](1.2_box_confidence_index.png)

![confidence_index](2.2_dist_confidence_index.png)

### shift_code

- **dtype** Int64 · **count** 1245 · **unique** 3 · **missing** 0 (0.0%)
- **range** 0.0 → 2.0 (span 2.0) · **Q1/median/Q3** 0.0 / 1.0 / 2.0
- **mean** 0.985 · **std** 0.819 · **skew** 0.028
