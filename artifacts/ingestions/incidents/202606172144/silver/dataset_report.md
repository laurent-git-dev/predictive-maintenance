...
- **mean** 1.012 · **std** 0.109 · **skew** 8.956 · **IQR outliers** 15
- **distinct values**: 1, 2

![n_active_signals](1.2_box_n_active_signals.png)

![n_active_signals](2.2_dist_n_active_signals.png)

### confidence_index

- **dtype** float64 · **count** 1245 · **unique** 2 · **missing** 0 (0.0%)
- **range** 0.111 → 0.222 (span 0.111) · **Q1/median/Q3** 0.111 / 0.111 / 0.111
- **mean** 0.112 · **std** 0.012 · **skew** 8.956 · **IQR outliers** 15
- **distinct values**: 0.1111, 0.2222

![confidence_index](1.3_box_confidence_index.png)

![confidence_index](2.3_dist_confidence_index.png)

### shift_code

- **dtype** Int64 · **count** 1245 · **unique** 3 · **missing** 0 (0.0%)
- **range** 0.0 → 2.0 (span 2.0) · **Q1/median/Q3** 0.0 / 1.0 / 2.0
- **mean** 0.985 · **std** 0.819 · **skew** 0.028 · **IQR outliers** 0
