...
![Maintenance events per machine](1.1_hist_maintenance_machine.png)

### Maintenance duration by machine
![Maintenance duration by machine](1.2_box_duration_machine.png)

### Proactive vs reactive per machine
![Proactive vs reactive per machine](1.3_maintenance_type_split.png)

### Maintenance events per component
![Maintenance events per component](1.4_hist_maintenance_component.png)
