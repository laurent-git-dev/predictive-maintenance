...
``from src.usecase.notebook.render import *``).
...
from src.framework.common.overview import global_overview
from src.framework.common.processing_summary import per_feature_processing_markdown
from src.framework.common.profiling import (
...
from src.usecase.gold.features import FEATURES_COUNT, FEATURES_NUMERIC
...
def show_bronze_processing(name):
    ...
    from src.framework.ingestion.stats import plot_parse_reasons, reason_table_markdown
...
def show_silver_preview(name):
    ...
    from src.framework.ingestion.stats import reason_table_markdown
    from src.usecase.silver.refine import read_bronze_table, split_rejected
...
def show_silver_processing(name):
    ...
    from src.usecase.silver.refine import read_bronze_table, refine_silver, split_rejected
...
def show_gold_usecase():
    ...
    from src.usecase.gold.features import read_silver
...
def show_gold_build():
    ...
    from src.framework.db.engine import get_engine, is_available
    from src.framework.db.loader import write_table
    from src.usecase.gold.features import build_gold_from_db
...
def show_gold_overview():
    ...
    from src.usecase.gold.features import read_silver
    from src.usecase.gold.stats import label_markdown, plot_label_positive_rates, summary_markdown
