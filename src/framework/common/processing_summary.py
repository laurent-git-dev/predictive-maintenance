...
exactly what :func:`src.framework.processing.pipeline.apply_processing` (and the source's feature
...
from src.framework.common.profiling import new_feature_badge
